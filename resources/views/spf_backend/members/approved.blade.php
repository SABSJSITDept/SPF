@include('includes.backend.header')
    ...
    <style>
        ...
        .badge { background: #2e7d32; color: #fff; font-size: 12px; padding: 3px 10px; border-radius: 12px; margin-left: 10px; }
        ...
        .status-badge { display:inline-block; padding:3px 10px; border-radius:12px; font-size:11px; font-weight:600; background:#e8f5e9; color:#2e7d32; }
    ...
    <div>
        <div class="breadcrumb">
            <a href="{{ route('admin.dashboard') }}">Dashboard</a> &rsaquo; Members &rsaquo; Approved
        </div>

        <h1>Approved Members <span class="badge">{{ $registrations->total() }} Records</span></h1>
        ...
        <div class="table-wrapper">
            @if($registrations->isEmpty())
                <p class="no-records">No approved registrations found.</p>
            @else
            <table id="membersTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-status"><span class="status-badge">Approved</span></td>
                        ...
                        <td>
                            <form method="POST" action="{{ route('admin.members.updateStatus', $reg->id) }}" style="display:inline;">
                                ...
                                <button type="button" onclick="confirmSubmit(this.form, 'Mark as Rejected?', '#c62828')"
